...
class Sampling:
    ...
    def sample(
        ...
        # Buffer to hold tokens as they're generated. Concatenated with new
        # tokens along the sequence dimension and reassigned; not assigned
        # into.
        ...
        for i in range(n_tokens, up_to):
            # Current sequence length, before generation of new token.
            seq = i + n_params

            # Embed current logits and update using attention
            ...
            prob_dist = self.deembedding_function(
                logits[seq - 1, :, :], calculate_phase=False
